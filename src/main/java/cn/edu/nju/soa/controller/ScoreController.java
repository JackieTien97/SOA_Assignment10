...
import cn.edu.nju.soa.definition.Score;
 ...
 * Score controller
 */
@WebService(name = "Score", targetNamespace = "http://jw.nju.edu.cn/model")
@Component
public class ScoreController implements Score {
     ...
     * @return returns cn.edu.nju.jw.model.CourseScoreListType
     * @throws IdNotFoundException cannot find id
     */
    @Override
    @Transactional
