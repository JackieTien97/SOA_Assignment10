...
public interface Score {
    ...
    @RequestWrapper(localName = "addScore", targetNamespace = "http://jw.nju.edu.cn/model", className = "cn.edu.nju.jw.model.AddScoreType")
    @ResponseWrapper(localName = "modifyScore", targetNamespace = "http://jw.nju.edu.cn/model", className = "cn.edu.nju.jw.model.ModifyScoreType")
    ...
    void addScore(
            @WebParam(name = "课程成绩列表", targetNamespace = "http://jw.nju.edu.cn/model", mode = WebParam.Mode.INOUT)
     ...
     * @return
     *     returns cn.edu.nju.jw.model.CourseScoreListType
     * @throws IdNotFoundException cannot find id
     */
    @WebMethod(action = "score/getScore")
    @WebResult(name = "课程成绩列表", targetNamespace = "http://jw.nju.edu.cn/model", partName = "parameters")
    ...
    CourseScoreListType getScore(
            @WebParam(name = "学号", targetNamespace = "http://jw.nju.edu.cn/model", partName = "parameters")
                    String parameters)
    ...
    void modifyScore(
            @WebParam(name = "课程成绩列表", targetNamespace = "http://jw.nju.edu.cn/model", mode = WebParam.Mode.INOUT, partName = "parameters")
